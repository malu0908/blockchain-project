...
module.exports.info  = 'Reading information from file inputevents_cv';
...
function processFile(){
    ...
    const csvString = fs.readFileSync("/home/ana/physionet.org/files/mimiciii/1.4/INPUTEVENTS_CV.csv").toString("utf-8");
...
function generateWorkload() {
    ...
    for(let i= total-1; i < total; i++) {
        ...
        if (bc.getType() === 'fabric') {
            workload.push({
                chaincodeFunction: 'insertInputeventCv',
                ...
                csv[total][18], csv[total][19], csv[total][20]]
            });
        } 
    }
    return workload;
...
module.exports.run = function() {
    ...
    return bc.invokeSmartContract(contx, 'testecouch', 'v0', args, 4000);
};
