...
module.exports.info  = 'Reading information from file d_icd_procedures';
...
function processFile(){
    ...
    const csvString = fs.readFileSync("/home/ana/physionet.org/files/mimiciii/1.4/D_ICD_PROCEDURES.csv").toString("utf-8");
...
function generateWorkload() {
    ...
    for(let i= total-1; i < total; i++) {
        ...
        if (bc.getType() === 'fabric') {
            workload.push({
                chaincodeFunction: 'insertDicdProcedures',
