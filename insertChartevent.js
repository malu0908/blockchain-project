...
module.exports.info  = 'Reading information from file chartevents';
...
function processFile(){
    ...
    const csvString = fs.readFileSync("/home/ana/physionet.org/files/mimiciii/1.4/CHARTEVENTS.csv").toString("utf-8");
...
function generateWorkload() {
    ...
    for(let i= total-1; i < total; i++) {
        ...
        if (bc.getType() === 'fabric') {
            workload.push({
                chaincodeFunction: 'insertChartevent',
