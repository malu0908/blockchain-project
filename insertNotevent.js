...
module.exports.info  = 'Reading information from noteevents';
...
module.exports.run = async function() {
    ...
    const fd = fs.openSync("/home/ana/physionet.org/files/mimiciii/1.4/NOTEEVENTS.csv", 'r');
    ...
    if(charBuffer.toString() === '\n') {
        ...
        if (bc.getType() === 'fabric') {
            args.push({
                chaincodeFunction: 'insertNoteevent',
    ...
    for (let result of results) {
        ...
        try {
            fs.appendFileSync('insertNoteeventResults.txt', executionTime + '\n');
        } catch (e) {
            console.log(e);
            throw e;
        }
