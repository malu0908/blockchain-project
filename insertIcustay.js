...
module.exports.info  = 'Reading information from file icustays';
...
module.exports.run = async function() {
    ...
    const fd = fs.openSync("/home/ana/physionet.org/files/mimiciii/1.4/ICUSTAYS.csv", 'r');
    ...
    if(charBuffer.toString() === '\n') {
        ...
        if (bc.getType() === 'fabric') {
            args.push({
                chaincodeFunction: 'insertIcustay',
    ...
    for (let result of results) {
        ...
        try {
            fs.appendFileSync('insertIcustayResults.txt', executionTime + '\n');
        } catch (e) {
            console.log(e);
            throw e;
        }
