...
module.exports.info  = 'Reading information from file caregivers';
...
function processFile(){
    ...
    const csvString = fs.readFileSync("/home/ana/physionet.org/files/mimiciii/1.4/CAREGIVERS.csv").toString("utf-8");
...
function generateWorkload() {
    ...
    for(let i= total-1; i < total; i++) {
        ...
        if (bc.getType() === 'fabric') {
            workload.push({
                chaincodeFunction: 'insertCaregiver',
...
module.exports.run = function() {
    ...
    return bc.invokeSmartContract(contx, 'testecouch', 'v0', args, 10000);
};
