...
module.exports.info  = 'Reading information from file microbiologyevents';
...
function processFile(){
    ...
    const csvString = fs.readFileSync("/home/ana/physionet.org/files/mimiciii/1.4/MICROBIOLOGYEVENTS.csv").toString("utf-8");
...
function generateWorkload() {
    ...
    for(let i= total-1; i < total; i++) {
        ...
        if (bc.getType() === 'fabric') {
            workload.push({
                chaincodeFunction: 'insertMicrobiologyevent',
                ...
                csv[total][13], csv[total][14], csv[total][15]]
            });
        } 
    }
    return workload;
