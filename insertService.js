...
module.exports.info  = 'Reading information from file services';
...
module.exports.run = async function() {
    ...
    const fd = fs.openSync("/home/ana/physionet.org/files/mimiciii/1.4/SERVICES.csv", 'r');
    ...
    if(charBuffer.toString() === '\n') {
        ...
        if (bc.getType() === 'fabric') {
            args.push({
                chaincodeFunction: 'insertService',
    ...
    for (let result of results) {
        ...
        try {
            fs.appendFileSync('insertServiceResults.txt', executionTime + '\n');
        } catch (e) {
            console.log(e);
            throw e;
        }
